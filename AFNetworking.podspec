Pod::Spec.new do |s|
  ...
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me', 'Adam Milligan' => 'adam@orchardpie.com' }
  s.source   = { :git => 'https://github.com/orchardpie/AFNetworking.git', :tag => "2.2.2", :submodules => true }
  s.requires_arc = true
